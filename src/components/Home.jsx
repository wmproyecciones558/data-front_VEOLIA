...
const Home = () => {
  return (
    <div>
      {" "}
      <img className=" h-56 <w-900></w-96> " src="/public/inicio.png"></img>
      <h1>
        ...
        mismo, que lo busque, lo encuentre y lo quiera, simplemente porque es el
        dolor." freestar ¿Qué es Lorem Ipsum? Lorem Ipsum es simplemente el
        ...
        Ipsum. ¿Por qué lo usamos? Es un hecho establecido hace demasiado tiempo
        que un lector se distraerá con el contenido del texto de un sitio
        mientras que mira su diseño. El punto de usar Lorem Ipsum es que tiene
        una distribución más o menos normal de las letras, al contrario de usar
